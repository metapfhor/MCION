...
fb=0.00001;
global pulse3IVM
global g1 g2 H2 L51 L52 L53 L54 L61 L62 L63 L64  L21 L22 L23 L24 L31 L32 L33 L34 L41 L42 L43 L44 k7 k9 k11 k13 k17 k19 k15 k21 k23 L11 L12 L13 L14 k2 k4 k6 k1 k3 k5 k8 k10 k12 k14 k16 k18 k20 k22 k24 E1 E2 alpha1 alpha2 alpha3 beta1 beta2 beta3 H11 H12 H13 H14 ks1 ks2 ks3 ks4 kd1 kd2 kd3 kd4 mu
% 
% load('twalk_P2X4StackDeMix3_var_1&3_IVM1600_steps@20150127T205243.mat')
% 
% P2X4StackDeMix3.setParams(x0);
% 
...
%     [I0pred]=prestimDoseResponse(0,P2X4StackDeMix3);
% %     [I10pred]=prestimDoseResponse(10,P2X4StackDeMix3);
%     [I30pred]=prestimDoseResponse(30,P2X4StackDeMix3);
% 
% 
% 
% 
...
cf(5);[e0,ef]=plotIVCurve(ramp,P2X4StackDeMix3);
...
% [T,I,Imax,Y]=lastIVMPulseIntegratorP2X4(exp.conditions{:},P2X4StackDeMix3);
% toff=exp.conditions{2};
% Ioff=I(T>toff(8));
...
% 
% subplot(2,1,2);
% plotWatchedStates(T,Y,P2X4StackDeMix3);
% axis tight;