...
[err41] = dataVarError(pulse10s,P2X4freeDe);
...
cf(55);plotPulseShort(pulse1IVM,P2X4freeDe);
% 
...
save(['twalk_P2X4freeDe_IVM' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
