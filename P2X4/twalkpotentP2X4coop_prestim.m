...
[err1] = normDataErrorOmar(pulse0IVM,potentP2X4coop);
[err2] = normDataErrorOmar(pulse1IVM,potentP2X4coop);
[err3] = normDataErrorOmar(pulse3IVM,potentP2X4coop);
[err4] = normDataErrorOmar(pulse10IVM,potentP2X4coop);
[err5] = normDataErrorOmar(prol3IVM,potentP2X4coop);
[err6] = normDataErrorOmar(prol2noIVM,potentP2X4coop);

err7 = metricSSE(@ATPDoseResponse,potentP2X4coop,Icontrol);
err8 = metricSSE(@ATPDoseResponse10,potentP2X4coop,I10);
err9 = metricSSE(@ATPDoseResponse30,potentP2X4coop,I30);
...
dilation = modelDilation(potentP2X4coop);
...
% cf(4);plotNaiveResponse(pulse0IVM,potentP2X4coop);

% cf(5);plotNaiveResponse(pulse1IVM,potentP2X4coop);

% cf(6);plotNaiveResponse(pulse3IVM,potentP2X4coop);

% cf(7);plotNaiveResponse(pulse10IVM,potentP2X4coop);

% cf(8);plotNaiveResponse(prol3IVM,potentP2X4coop);

% cf(9);plotNaiveResponse(prol2noIVM,potentP2X4coop);

 cf(10);chainPrestimDoseResponse(xp0,potentP2X4coop);
...
% cf(14);plotNaiveResponse(pulse0IVM,potentP2X4coop);

% cf(15);plotNaiveResponse(pulse1IVM,potentP2X4coop);

% cf(16);plotNaiveResponse(pulse3IVM,potentP2X4coop);

% cf(17);plotNaiveResponse(pulse10IVM,potentP2X4coop);

% cf(18);plotNaiveResponse(prol3IVM,potentP2X4coop);

% cf(19);plotNaiveResponse(prol2noIVM,potentP2X4coop);

 cf(20);chainPrestimDoseResponse(x0,potentP2X4coop);
...
save(['twalk_potentP2X4coop_Med' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
