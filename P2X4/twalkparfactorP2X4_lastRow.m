...
[err1] = normDataErrorOmar(pulse0IVM,factorP2X4,0.03);
[err2] = normDataErrorOmar(pulse1IVM,factorP2X4,0.04);
[err3] = normDataErrorOmar(pulse3IVM,factorP2X4,0.05);
[err4] = normDataErrorOmar(pulse10IVM,factorP2X4,0.05);
[err5] = normDataErrorOmar(prol3IVM,factorP2X4,0.05);
[err6] = normDataErrorOmar(prol2noIVM,factorP2X4,0.05);
...
save(['twalk_factorP2X4_lastRow' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
