...
err8 = normIVMRecoveryError(P2X4stack);
...
p = struct('globalStruct',glblStruct,'logPrior', @(x) dilation(x), 'logLikelihood',{{err1,err2,err3,err4,err8}},'bounds',bounds);
...
% 
cf(21);plotIVMAction(P2X4stack);

 

save(['twalk_P2X4stack_var_all_IVM' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
