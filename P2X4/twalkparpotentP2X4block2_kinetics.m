...
[err1] = normDataErrorOmar(pulse0IVM,potentP2X4block2);
[err2] = normDataErrorOmar(pulse1IVM,potentP2X4block2);
[err3] = normDataErrorOmar(pulse3IVM,potentP2X4block2);
[err4] = normDataErrorOmar(pulse10IVM,potentP2X4block2);
[err5] = normDataErrorOmar(prol3IVM,potentP2X4block2);
[err6] = normDataErrorOmar(prol2noIVM,potentP2X4block2);

err7 = normPrestimDoseError(potentP2X4block2);
...
% dilation = modelDilation(potentP2X4block2);
...
p = struct('globalStruct',globalStruct,'logPrior', @(x) poolIndepDilation(x), 'logLikelihood',{{err1,err2,@(x) 100*err4(x),err6}},'bounds',bounds);
...
cf(4);plotNaiveResponse(pulse0IVM,potentP2X4block2);

cf(5);plotNaiveResponse(pulse1IVM,potentP2X4block2);

cf(6);plotNaiveResponse(pulse3IVM,potentP2X4block2);
% 
cf(7);plotNaiveResponse(pulse10IVM,potentP2X4block2);
% 
cf(8);plotNaiveResponse(prol3IVM,potentP2X4block2);
% 
cf(9);plotNaiveResponse(prol2noIVM,potentP2X4block2);

 cf(10);chainPrestimDoseResponse(xp0,potentP2X4block2);
...
%  
% 
cf(14);plotNaiveResponse(pulse0IVM,potentP2X4block2);

cf(15);plotNaiveResponse(pulse1IVM,potentP2X4block2);

cf(16);plotNaiveResponse(pulse3IVM,potentP2X4block2);

cf(17);plotNaiveResponse(pulse10IVM,potentP2X4block2);
% 
cf(18);plotNaiveResponse(prol3IVM,potentP2X4block2);
% 
cf(19);plotNaiveResponse(prol2noIVM,potentP2X4block2);

 cf(20);chainPrestimDoseResponse(x0,potentP2X4block2);


% cf(21);prestimDoseResponses(potentP2X4block2);

 

save(['twalk_potentP2X4block2_kinetics_' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
