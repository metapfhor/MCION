...
err7 = normPrestimDoseControlError(potentP2X4sub);
...
p = struct('globalStruct',glblStruct,'logPrior', @(x) dilation(x), 'logLikelihood',{{err1,err6,@(x) 10*err7(x)}},'bounds',bounds);
...
save(['twalk_omarP2X4coop_noIVM_and_prestimControl' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
