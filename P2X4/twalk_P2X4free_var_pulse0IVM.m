...
p = struct('globalStruct',glblStruct,'logPrior', @(x) dilation(x), 'logLikelihood',{{err1}},'bounds',bounds);
...
% [x0,xp0]=twalkStringParse('H1= [5.98948e-03, 4.55266e-03], H2= [1.39089e-01, 1.13112e-01], H3= [2.78273e-02, 2.56868e-02], H4= [2.95041e-05, 1.69071e-05], g1= [3.03786e-08, 2.30435e-08], k1= [9.94289e+00, 1.20356e+01], k2= [1.73032e+06, 2.01818e+06], k3= [8.47183e+00, 2.71507e+00], k4= [4.64684e+06, 1.75618e+06], k5= [3.11055e+01, 5.21783e+01], k6= [6.25967e+07, 1.72708e+08]');
