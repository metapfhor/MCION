...
p = struct('logPrior', @(x) 1, 'logLikelihood',@(x) -(emed(x)+err1(x)),'bounds',bounds);
...
save(['twalk_omarP2X4_Med_IVM' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
