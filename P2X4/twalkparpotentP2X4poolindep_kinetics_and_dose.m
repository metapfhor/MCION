...
p = struct('globalStruct',globalStruct,'logPrior', @(x) poolIndepDilation(x), 'logLikelihood',{{err2,err3,err4,err5}},'bounds',bounds);
...
save(['twalk_potentP2X4poolindep_kinetics_and_dose' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
