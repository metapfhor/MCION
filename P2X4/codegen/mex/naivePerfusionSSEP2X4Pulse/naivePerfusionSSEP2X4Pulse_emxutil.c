 ...
 *
 * Code generation for function 'naivePerfusionSSEP2X4Pulse_emxutil'
 *
...
void b_emxInit_boolean_T(emxArray_boolean_T **pEmxArray, int32_T b_numDimensions,
...
void b_emxInit_int32_T(emxArray_int32_T **pEmxArray, int32_T b_numDimensions,
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
...
void b_emxInit_real_T(emxArray_real_T **pEmxArray, int32_T b_numDimensions,
                      const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
...
void emxInit_boolean_T(emxArray_boolean_T **pEmxArray, int32_T b_numDimensions,
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxArray_boolean_T *emxArray;
  int32_T i;
...
void emxInit_int32_T(emxArray_int32_T **pEmxArray, int32_T b_numDimensions,
                     const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxArray_int32_T *emxArray;
  int32_T i;
...
/* End of code generation (naivePerfusionSSEP2X4Pulse_emxutil.c) */
