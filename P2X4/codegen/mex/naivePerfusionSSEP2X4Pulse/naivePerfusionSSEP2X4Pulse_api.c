/*
 * naivePerfusionSSEP2X4Pulse_api.c
 *
 * Code generation for function 'naivePerfusionSSEP2X4Pulse_api'
 *
...
static emlrtRTEInfo i_emlrtRTEI = { 1, 1, "naivePerfusionSSEP2X4Pulse_api", "" };
...
static void c_info_helper(ResolvedFunctionInfo info[157])
{
  ...
  info[156].context =
    "[E]/home/cnd/omar.khan/Desktop/Final_MCMC_folder/Models/naivePerfusionSSEP2X4Pulse.m";
...
static void info_helper(ResolvedFunctionInfo info[157])
{
  ...
  info[14].resolved =
    "[E]/home/cnd/omar.khan/Desktop/Final_MCMC_folder/Models/linearODESSEP2X4.m";
  info[14].fileTimeLo = 1401483956U;
  ...
  info[15].fileTimeLo = 1401483923U;
...
void naivePerfusionSSEP2X4Pulse_api(const mxArray *prhs[5], const mxArray *plhs
  [1])
{
  emxArray_real_T *ton;
  ...
  if (tmp) {
    k7 = c_emlrt_marshallIn(tmp, "k7");
    k7_dirty = 0U;
  }

  tmp = mexGetVariable("global", "k10");
  if (tmp) {
    k10 = c_emlrt_marshallIn(tmp, "k10");
    k10_dirty = 0U;
  }
  ...
  tmp = mexGetVariable("global", "alpha");
  if (tmp) {
    alpha = c_emlrt_marshallIn(tmp, "alpha");
    alpha_dirty = 0U;
  }
  ...
  if (tmp) {
    k9 = c_emlrt_marshallIn(tmp, "k9");
    k9_dirty = 0U;
  }

  tmp = mexGetVariable("global", "k12");
  if (tmp) {
    k12 = c_emlrt_marshallIn(tmp, "k12");
    k12_dirty = 0U;
  }

  tmp = mexGetVariable("global", "k11");
  if (tmp) {
    k11 = c_emlrt_marshallIn(tmp, "k11");
    k11_dirty = 0U;
  }
  ...
  Ttot = naivePerfusionSSEP2X4Pulse(ton, toff, Ttot, T, I);
...
/* End of code generation (naivePerfusionSSEP2X4Pulse_api.c) */
