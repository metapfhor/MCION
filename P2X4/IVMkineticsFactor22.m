function f = indepcoopDilation(model)
    ...
    function  b = dilation(x)
        ...
        global g1 g2 r1 r2 r3 v1 v2 v3 H3 H3D H2 H21 H22 H23 H24 d1 d2 d3 d4 d5 d6 d7 d8 d13 d19
        global delta epsilon mu
        global kd1 kd2 kd3 kd4 ks1 ks2 ks3 ks4
        global H11 H12 H13 H14 n1 n2
        
        global W1 W2 W3 W4 W5 W6 L1 L2 L3 L4 L5 L6 H0 H5
        ...
        Imax= (60e-3*g1*H0/(H0+H5))/10^-12;
        
        if  ks3<0.5 && 0.01>H3D && 0.005>L31 && 0.005>L32 && 0.005>L33 && 0.005>L34 && Imax<2500 && kd3<kd2 && kd4<kd3 && delta>=3e-7 && delta<epsilon && epsilon<mu && g1<g2 && g2<1.5*g1 % && L41<L42 && L42<L43 && L43<L44 && g1<g2% && v1<1 && v3<1 
