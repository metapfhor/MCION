...
err7 = metricSSE(@ATPDoseResponse,potent2P2X4,Icontrol);
err8 = metricSSE(@ATPDoseResponse10,potent2P2X4,I10);
err9 = metricSSE(@ATPDoseResponse30,potent2P2X4,I30);
...
p = struct('logPrior', @(x) dilation(x), 'logLikelihood',@(x) -(err4(x)+err7(x)+err8(x)+err9(x)),'bounds',bounds);
...
save(['twalk_potent2P2X4_Med' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
