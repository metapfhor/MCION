function f = indepcoopDilation(model)
    ...
    function  b = dilation(x)
        ...
        trQ=trace(Q);
        rho=30;
        if  g1<g2 && g2<1.5*g1 % && L41<L42 && L42<L43 && L43<L44 && g1<g2% && v1<1 && v3<1 
            b=trQ/rho+n1^2+n2^2;%-sum([IVMback,IVMfor,H21,H22,H23,H24,d1,d3,d5,d7].^2);%-sum([500*IVMback,10000*IVMfor,Aback,Afor*Amax].^2);
        else
            b=0;
        end
    end
