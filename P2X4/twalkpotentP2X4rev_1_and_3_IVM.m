...
err7 = metricSSE(@ATPDoseResponse,potentP2X4rev,Icontrol);
err8 = metricSSE(@ATPDoseResponse10,potentP2X4rev,I10);
err9 = metricSSE(@ATPDoseResponse30,potentP2X4rev,I30);
...
p = struct('logPrior', @(x) dilation(x), 'logLikelihood',@(x) -(err2(x)+err3(x)),'bounds',bounds);
...
save(['twalk_potentP2X4rev_Med' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
