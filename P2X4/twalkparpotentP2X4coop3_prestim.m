...
p = struct('globalStruct',glblStruct,'logPrior', @(x) dilation(x), 'logLikelihood','normPrestimDoseErrorpotentP2X4coop3','bounds',bounds);
...
% cf(19);plotNaiveResponse(prol2noIVM,potentP2X4coop3);
 ...
 cf(20);chainPrestimDoseResponse(x0,potentP2X4coop3);
...
save(['twalk_potentP2X4coop3_preStim_only' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
