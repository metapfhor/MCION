...
p = struct('logPrior', @(x) dilation(x), 'logLikelihood',@(x) -(err2(x)+err3(x)+err5(x)),'bounds',bounds);
...
save(['twalk_potentP2X4coop3_Med' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
