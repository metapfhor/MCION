global baseParameters fparam parami nbin Acell calP2X4 iparam parami baseModel pMax pMin;
...
p = struct('logPrior', @(x) 1, 'logLikelihood',@(x) -(err8(x)+err9(x0)),'bounds',bounds);
...
%     continueChain(x0);
% 	figure(13);plotPanelsResponse(fullP2X4);
% % 	plotPanelsActivation(fullP2X4);
%     continueChain(xp0);
%     figure(14);plotPanelsResponse(fullP2X4);
%     drawnow
% 
% 	
% end
...
cf(20);chainPrestimDoseResponse([x0,xp0],factorP2X4coop);
