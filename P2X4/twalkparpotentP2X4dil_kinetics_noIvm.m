...
paramNames={'k1','k2','k3','k4','k5','k6','k7','k8','k9','k10','k11','k12','kd0','ku0','kd1','ku1','kd2','ku2','kd3','ku3','L1','L2','L3','L4','L5','L6','L7','L8','L9','L10','L11','L12','H1','H2','H3','H4','g1','g2','E1','E2','V','epsilon','delta','mu','A','J','n1','n2','n3','r3','r2','r1','v3','v2','v1','a1','a2','a3','alpha'};
...
p = struct('globalStruct',globalStruct,'logPrior', @(x) dilation(x), 'logLikelihood',{{err1}},'bounds',bounds);
...
% cf(21);prestimDoseResponses(P2X4sub);

 

save(['twalk_P2X4sub_kinetics_lastRow_' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
