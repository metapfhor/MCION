function f = indepcoopDilation(model)
    ...
    function  b = dilation(x)
        ...
        global g1 g2 v1 v2 v3 H3 H3D H2 H21 H22 H23 H24 d1 d2 d3 d4 d5 d6 d7 d8 d13 d19
        global delta epsilon mu
        global kd1 kd2 kd3 kd4 ks1 ks2 ks3 ks4
        global H11 H12 H13 H14 n1 n2
        global r1        
        global W1 W2 W3 W4 W5 W6 L1 L2 L3 L4 L5 L6
        ...
        c12=r1*k6*1e-6/(v1*k5);
        J= 3e-7;
        g3 = J^4/(J^4+mu^4);
        r34=L6*g3/L5;
        
        
        if  r34>0.1 && c12<1e6 && v1<1 && v2<v1 && v3<v2 && L6*g>L5 && delta>=1e-7&& delta<epsilon && epsilon<mu && W2>W1 && g1<g2 && g2<1.5*g1 % && L41<L42 && L42<L43 && L43<L44 && g1<g2% && v1<1 && v3<1 
