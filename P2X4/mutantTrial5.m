...
% 
% load('twalk_P2X4StackDeMix6_var_1&3_IVM1600_steps@20150127T205243.mat')
% 
% P2X4StackDeMix6.setParams(x0);
% 

load('twalk_P2X4StackDeMix6_var_all1000_steps@20150306T131309.mat')
P2X4StackDeMix6.setParams(x0);
...
%     [I0pred]=prestimDoseResponse(0,P2X4StackDeMix6);
% %     [I10pred]=prestimDoseResponse(10,P2X4StackDeMix6);
%     [I30pred]=prestimDoseResponse(30,P2X4StackDeMix6);
% 
% 
% 
% 
...
cf(5);[e0,ef]=plotIVCurve(ramp,P2X4StackDeMix6);
...
% [T,I,Imax,Y]=lastIVMPulseIntegratorP2X4(exp.conditions{:},P2X4StackDeMix6);
% toff=exp.conditions{2};
% Ioff=I(T>toff(8));
...
% 
% subplot(2,1,2);
% plotWatchedStates(T,Y,P2X4StackDeMix6);
% axis tight;