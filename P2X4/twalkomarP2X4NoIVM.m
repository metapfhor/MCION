...
p = struct('logPrior', @(x) intern(x), 'logLikelihood',@(x) -(err6(x)+50*err1(x)),'bounds',bounds);
...
save(['twalk_omarP2X4_NoIVM_' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
