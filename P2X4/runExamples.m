...
v=baseParameters.values;
input.data =[v{:}].'; [1.12345 NaN 3.12345; ...
...
input.tableRowLabels =baseParameters.keys.';
...
%
input.dataFormat = {'%.3f',1}; % three digits precision for first two columns, one digit for the last
