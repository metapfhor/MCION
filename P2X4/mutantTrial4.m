...
% 
% load('twalk_P2X4StackDeMix5alt_var_1&3_IVM1600_steps@20150127T205243.mat')
% 
% P2X4StackDeMix5alt.setParams(x0);
% 
...
%     [I0pred]=prestimDoseResponse(0,P2X4StackDeMix5alt);
% %     [I10pred]=prestimDoseResponse(10,P2X4StackDeMix5alt);
%     [I30pred]=prestimDoseResponse(30,P2X4StackDeMix5alt);
% 
% 
% 
% 
...
cf(5);[e0,ef]=plotIVCurve(ramp,P2X4StackDeMix5alt);
...
% [T,I,Imax,Y]=lastIVMPulseIntegratorP2X4(exp.conditions{:},P2X4StackDeMix5alt);
% toff=exp.conditions{2};
% Ioff=I(T>toff(8));
...
% 
% subplot(2,1,2);
% plotWatchedStates(T,Y,P2X4StackDeMix5alt);
% axis tight;