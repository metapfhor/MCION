...
[err5] = dataVarError(prol3IVM,P2X4free);
...
p = struct('globalStruct',glblStruct,'logPrior', @(x) dilation(x), 'logLikelihood',{{@(x) 10*err1(x),err2,err3,err4,err5,err6,@(x) err7(x),@(x) err8(x)}},'bounds',bounds);
...
% 
cf(8);plotNaiveResponse(prol3IVM,P2X4free);
...
% % 
cf(18);plotNaiveResponse(prol3IVM,P2X4free);
% 
