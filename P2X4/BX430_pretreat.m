...
d3=k3*10;
d5=k5*10;
[T1,I1,Y1]=P2X4BX430.naivePerfusionResponse(0,5,5);

Yf=Y1(end,:);


B=5e-6;
[T2,I2,Y2]=P2X4BX430.perfusionResponse(Yf,5,5,5);

Yf=Y2(end,:);

A=50e-6;
[T3,I3,Y3]=P2X4BX430.perfusionResponse(Yf,0,5,5);

Yf=Y3(end,:);

B=0e-6;
[T4,I4,Y4]=P2X4BX430.perfusionResponse(Yf,5,5,5);

Yf=Y4(end,:);
A=50e-6;
[T5,I5,Y5]=P2X4BX430.perfusionResponse(Yf,0,5,10);

cf(2);

subplot(2,1,1);
plot([T1;T2+5;T3+10;T4+15;T5+20],[I1;I2;I3;I4;I5]);

subplot(2,1,2);
plotWatchedStates([T1;T2+5;T3+10;T4+15;T5+20],[Y1;Y2;Y3;Y4;Y5],P2X4BX430);