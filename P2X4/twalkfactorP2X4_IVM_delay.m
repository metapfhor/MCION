...
[err1] = normDataErrorOmar(pulse0IVM,factorP2X4);
[err2] = normDataErrorOmar(pulse1IVMdel,factorP2X4);
[err3] = normDataErrorOmar(pulse3IVMdel,factorP2X4);
[err4] = normDataErrorOmar(pulse10IVMdel,factorP2X4);
[err5] = normDataErrorOmar(prol3IVM,factorP2X4);
[err6] = normDataErrorOmar(prol2noIVM,factorP2X4);
...
p = struct('logPrior', @(x) 1, 'logLikelihood',{{err2,err3,err4,err5}},'bounds',bounds);
...
cf(5);plotNaiveResponse(pulse1IVMdel,factorP2X4);

cf(6);plotNaiveResponse(pulse3IVMdel,factorP2X4);

cf(7);plotNaiveResponse(pulse10IVMdel,factorP2X4);
...
cf(15);plotNaiveResponse(pulse1IVMdel,factorP2X4);

cf(16);plotNaiveResponse(pulse3IVMdel,factorP2X4);

cf(17);plotNaiveResponse(pulse10IVMdel,factorP2X4);

cf(18);plotNaiveResponse(prol3IVM,factorP2X4);

% cf(19);plotNaiveResponse(prol2noIVM,factorP2X4);

cf(20);chainPrestimDoseResponse(x0,factorP2X4);
