...
p = struct('globalStruct',globalStruct,'logPrior', @(x) 1, 'logLikelihood',{{err2,err3,err4,err5}},'bounds',bounds);
...
save(['twalk_potentP2X4dil_kinetics_' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
