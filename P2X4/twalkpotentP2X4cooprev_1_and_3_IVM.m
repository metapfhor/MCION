...
[err1] = normDataErrorOmar(pulse0IVM,potentP2X4cooprev);
[err2] = normDataErrorOmar(pulse1IVM,potentP2X4cooprev);
[err3] = normDataErrorOmar(pulse3IVM,potentP2X4cooprev);
[err4] = normDataErrorOmar(pulse10IVM,potentP2X4cooprev);
[err5] = normDataErrorOmar(prol3IVM,potentP2X4cooprev);
[err6] = normDataErrorOmar(prol2noIVM,potentP2X4cooprev);

err7 = metricSSE(@ATPDoseResponse,potentP2X4cooprev,Icontrol);
err8 = metricSSE(@ATPDoseResponse10,potentP2X4cooprev,I10);
err9 = metricSSE(@ATPDoseResponse30,potentP2X4cooprev,I30);
...
dilation = modelDilation(potentP2X4cooprev);


p = struct('logPrior', @(x) dilation(x), 'logLikelihood',@(x) -(err2(x)+err3(x)+err5(x)+err4(x)),'bounds',bounds);
...
% cf(4);plotNaiveResponse(pulse0IVM,potentP2X4cooprev);

cf(5);plotNaiveResponse(pulse1IVM,potentP2X4cooprev);

cf(6);plotNaiveResponse(pulse3IVM,potentP2X4cooprev);

cf(7);plotNaiveResponse(pulse10IVM,potentP2X4cooprev);

cf(8);plotNaiveResponse(prol3IVM,potentP2X4cooprev);

% cf(9);plotNaiveResponse(prol2noIVM,potentP2X4cooprev);

%  cf(10);chainPrestimDoseResponse(xp0,potentP2X4cooprev);
...
% cf(14);plotNaiveResponse(pulse0IVM,potentP2X4cooprev);

cf(15);plotNaiveResponse(pulse1IVM,potentP2X4cooprev);

cf(16);plotNaiveResponse(pulse3IVM,potentP2X4cooprev);

cf(17);plotNaiveResponse(pulse10IVM,potentP2X4cooprev);

cf(18);plotNaiveResponse(prol3IVM,potentP2X4cooprev);

% cf(19);plotNaiveResponse(prol2noIVM,potentP2X4cooprev);

%  cf(20);chainPrestimDoseResponse(x0,potentP2X4cooprev);
...
save(['twalk_potentP2X4cooprev_Med' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
