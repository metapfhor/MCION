function f = indepcoopDilation(model)
    ...
    function  b = dilation(x)
        ...
        if  Imax<2500 && ks2<kd2  && L1>2*L3 && v1<1 && v2<v1 && v3<v2 && L6*g>L5 && kd3<kd2 && kd4<kd3 && delta>=3e-7&& delta<epsilon && epsilon<mu && g1<g2 && g2<1.5*g1 % && L41<L42 && L42<L43 && L43<L44 && g1<g2% && v1<1 && v3<1 
