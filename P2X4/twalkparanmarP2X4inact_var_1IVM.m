...
[err1] = dataVarError(pulse0IVM,anmarP2X4inact);
[err2] = dataVarError(pulse1IVM,anmarP2X4inact);
[err3] = dataVarError(pulse3IVM,anmarP2X4inact);
[err4] = dataVarError(pulse10IVM,anmarP2X4inact);
[err5] = normProl3IVMErrorLite(anmarP2X4inact);
[err6] = normProl2noIVMError(anmarP2X4inact);

err7 = parPrestimDoseError30(anmarP2X4inact,anmarP2X4inact);


err8 = normIVMRecoveryError(anmarP2X4inact);

err9 = parIVMDoseResponseErr(anmarP2X4inact);



s5 = prol3IVMErrorFuture(anmarP2X4inact);

err6 = normProl2noIVMError(anmarP2X4inact);

s6 = prol2noIVMErrorFuture(anmarP2X4inact);

err7 = parPrestimDoseError30(anmarP2X4inact,anmarP2X4inact);

s7 = parPrestimDoseError30Future(anmarP2X4inact,anmarP2X4inact);

err8 = normIVMRecoveryError(anmarP2X4inact);

err9 = parIVMDoseResponseErr(anmarP2X4inact);

s9 = parIVMDoseResponseErrFuture(anmarP2X4inact);
...
dilation = IVMkinetics(anmarP2X4inact);
...
p = struct('globalStruct',glblStruct,'logPrior',@(x) 1,'futureLogLikelihood',{{s5,s6,s7,s9}}, 'parLogLikelihood',{{err5,err6}}, 'serLogLikelihood',@(x) -(err7(x)+err9(x)),'bounds',bounds);
...
% continueChain(xp0);
% 
% cf(4);plotNaiveResponse(pulse0IVM,anmarP2X4inact);
% % 
% cf(51);plotNaiveResponse(pulse1IVM,anmarP2X4inact);
% % 
% cf(6);plotNaiveResponse(pulse3IVM,anmarP2X4inact);
% % 
% cf(7);plotNaiveResponse(pulse10IVM,anmarP2X4inact);
% % 
% cf(8);plotNaiveResponse(prol3IVM,anmarP2X4inact);
% 
% cf(9);plotNaiveResponse(prol2noIVM,anmarP2X4inact);
% 
% cf(12);plotPrestimDoseResponse(anmarP2X4inact);
% 
% cf(10);prestimDoseResponses(anmarP2X4inact);
% 
% cf(11);plotIVMAction(anmarP2X4inact);
%     
...
% 
% % % % % % % 
% cf(14);plotNaiveResponse(pulse0IVM,anmarP2X4inact);
% % % 
% cf(15);plotNaiveResponse(pulse1IVM,anmarP2X4inact);
% % 
% % % cf(55);plotPulseShort(pulse1IVM,anmarP2X4inact);
% % %
% cf(16);plotNaiveResponse(pulse3IVM,anmarP2X4inact);
% 
% % cf(56);plotPulseShort(pulse3IVM,anmarP2X4inact);
% % 
% cf(17);plotNaiveResponse(pulse10IVM,anmarP2X4inact);
% % 
% % % cf(57);plotPulseShort(pulse10IVM,anmarP2X4inact);
% % % 
% cf(18);plotNaiveResponse(prol3IVM,anmarP2X4inact);
% 
% cf(22);plotPulseDoseResponse(anmarP2X4inact);
% % % 
% % cf(19);plotNaiveResponse(prol2noIVM,anmarP2X4inact);
% % 
% cf(20);prestimDoseResponses(anmarP2X4inact);
% % % % 
% % cf(21);plotIVMAction(anmarP2X4inact);
% % % % % % 

 

save(['twalk_anmarP2X4inact_var_all' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami','beta')
