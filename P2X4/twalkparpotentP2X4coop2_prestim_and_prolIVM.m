...
[err5] = normDataErrorOmar(prol3IVMsmall,potentP2X4coop2);
...
p = struct('globalStruct',glblStruct,'logPrior', @(x) 1, 'logLikelihood',{{err5,@(x) 1000*err7(x)}},'bounds',bounds);
...
cf(8);plotNaiveResponse(prol3IVMsmall,potentP2X4coop2);
...
% 
cf(18);plotNaiveResponse(prol3IVMsmall,potentP2X4coop2);
% 
