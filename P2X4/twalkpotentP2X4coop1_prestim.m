...
err7 = metricSSE(@ATPDoseResponse,potentP2X4coop1,Icontrol);
err8 = metricSSE(@ATPDoseResponse10,potentP2X4coop1,I10);
err9 = metricSSE(@ATPDoseResponse30,potentP2X4coop1,I30);
...
save(['twalk_potentP2X4coop1_preStim' num2str(Niter) '_steps@' datestr(now,30) '.mat' ],'x0','xp0','xxp','lt','acc','fparam','baseParameters','parami','iparam','parami')
