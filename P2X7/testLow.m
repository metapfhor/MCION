...
%No Cal, High ATP
[err1,Ncell] = cellDataError(exp1,fullP2X7);
[err2,Ncell]=cellDataError(exp10,fullP2X7);
[err3,Ncell]=cellDataError(exp100,fullP2X7);
...
[X, m, R, theta, beta, stats, sse, XA] = cell_adaptive_pt(@(x,l) -(100*err1(x,l)), param, Niter, 2);
...
%cf(9);plotDensity(sse(sse<1.5*10^6));

goodSamples=cullChain(X,sse,1.434*10^5);
