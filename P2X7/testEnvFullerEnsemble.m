...
err1=dataEnsembleError(exp1,fullerStickP2X7);
err2 = dataEnsembleError(exp3,fullerStickP2X7);
err3=dataEnsembleError(exp10,fullerStickP2X7);
err4=dataEnsembleError(exp32,fullerStickP2X7);
err5=dataEnsembleError(exp100,fullerStickP2X7);
...
[X, m, R, theta, beta, stats, sse, XA] = cell_adaptive_pt(@(x,l) -(err1(x,l)+err5(x,l)), param, Niter, 3);
