...
exp1.conditions={5,45,85};
exp1.globals=struct('A',3.2*10^-6,'V',-60*10^-3,'C',0);
exp1.activation.conditions={5,205,60};
exp1.activation.globals=exp1.globals;


exp1.func=@() veryLowP2X7(exp1.conditions{:});
exp1.activation.func=@() veryLowP2X7(exp1.activation.conditions{:});

exp3.conditions={5,45,85};
exp3.globals=struct('ATP',0.3*10^-6,'A',0.3*10^-6,'V',-60*10^-3,'C',0);
exp3.globals=struct('A',10^-5,'V',-60*10^-3,'C',0);

exp3.func=@() lowP2X79(exp3.conditions{:});
exp3.activation.func=@() veryLowP2X79(exp3.activation.conditions{:});
exp3.activation.conditions={5,125,45};
exp3.activation.globals=exp3.globals;

exp3.func=@() lowP2X7(exp3.conditions{:});
...
exp10.func=@() medP2X7(exp10.conditions{:});
...
exp32.func=@() medHiP2X7(exp32.conditions{:});
...
exp100.func=@() hiP2X7(exp100.conditions{:});
exp100.activation.func=@() hiP2X7(exp100.activation.conditions{:});

Nrec=10^2;

[t,I]=threeP2X7(exp1.conditions{1},exp1.conditions{2},exp1.conditions{3});
n1=length(t);
...
[t,I]=lowP2X7(exp3.conditions{1},exp3.conditions{2},exp3.conditions{3});
n3=length(t);
...
[t,I]=medP2X7(exp10.conditions{1},exp10.conditions{2},exp10.conditions{3});
n10=length(t);
...
[t,I]=medHiP2X7(exp32.conditions{1},exp32.conditions{2},exp32.conditions{3});
n32=length(t);
...
[t,I]=hiP2X7(exp100.conditions{1},exp100.conditions{2},exp100.conditions{3});
n100=length(t);
