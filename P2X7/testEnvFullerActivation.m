...
paramNames={'K1','k1','K2','k3','K3','k5','K4','L3','L4','L5','K5','k7','K6','k9','K7','k11','L1','L2','L3','H1','H2','H3','H4','H5','H6','H7','g12','g34','E12','E34','koff','C','V','A','alpha1','alpha3','alpha10','alpha32','alpha100','Ks1','Ks2','Ks3','Kd','Ks','Kds'};
...
%No Cal, High ATP
baseModel=fullerStickP2X7;
[err1,Ncell] = cellDataError(exp1,fullerStickP2X7);
[err2,Ncell] = cellDataError(exp3,fullerStickP2X7);
[err3,Ncell]=cellDataError(exp10,fullerStickP2X7);
[err4,Ncell]=cellDataError(exp32,fullerStickP2X7);
[err5,Ncell]=cellDataError(exp100,fullerStickP2X7);


err1=dataEnsembleError(exp1.activation,fullerStickP2X7);
err2 = dataEnsembleError(exp1.activation,fullerStickP2X7);
err3=dataEnsembleError(exp1.activation,fullerStickP2X7);
err4=dataEnsembleError(exp1.activation,fullerStickP2X7);
err5=dataEnsembleError(exp1.activation,fullerStickP2X7);
...
etot=@(x,l) -(err1(x,l)+err2(x,l)+err3(x,l)+err4(x,l)+err5(x,l));
[X, m, R, theta, beta, stats, sse, XA] = cell_adaptive_pt(@(x,l) -(err1(x,l)+err3(x,l)+err5(x,l)), param, Niter, 3);

continueChain(X,beta);

save(['envelopeFuller' num2str(Niter) '_steps@' num2str(L) '_levels_' datestr(now,30) '.mat' ],'X','beta','sse','R','fparam','baseParameters','parami','XA','iparam')
...
Acell=1;
 ...
 cf(13);plotPanelsResponse(fullerStickP2X7);
  cf(14);plotPanelsActivation(fullerStickP2X7);
%cf(3);plotChainPanels(fullerStickP2X7,goodSamples,15);
...
% K1= 6.24154e+05,, K2= 4.55641e+05, K3= 2.18614e+03, K4= 7.78188e+01, K5= 2.33001e+08, L1= 7.09617e-02, L3= 3.75760e+00, k1= 1.85130e-01, k3= 1.95623e-02, k5= 6.41368e-01, k7= 2.17834e-03
 ...
 %cf(7);plotNaiveResponse(exp100,fullerStickP2X7);