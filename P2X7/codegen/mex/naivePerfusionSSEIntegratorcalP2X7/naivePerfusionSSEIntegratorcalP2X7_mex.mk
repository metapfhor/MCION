START_DIR = /home/lmackay/gdrive/Research/Anmar/P2X-data/P2X7/Calcium\ Binding

MATLAB_ROOT = /usr/local/pkgs/MATLAB/R2013a
MAKEFILE = naivePerfusionSSEIntegratorcalP2X7_mex.mk

include naivePerfusionSSEIntegratorcalP2X7_mex.mki


SRC_FILES =  \
	naivePerfusionSSEIntegratorcalP2X7_mexutil.c \
	naivePerfusionSSEIntegratorcalP2X7_data.c \
...
MEX_FILE_NAME_WO_EXT = naivePerfusionSSEIntegratorcalP2X7_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/naivePerfusionSSEIntegratorcalP2X7"
SYS_INCLUDE += -I "/home/lmackay/gdrive/Research/Anmar/P2X-data/P2X7/Models"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/naivePerfusionSSEIntegratorcalP2X7/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/naivePerfusionSSEIntegratorcalP2X7/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/naivePerfusionSSEIntegratorcalP2X7/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
