/*
 * linearODESolvecalP2X7.c
 *
 * Code generation for function 'linearODESolvecalP2X7'
 *
...
static emlrtRSInfo mb_emlrtRSI = { 4, "linearODESolvecalP2X7",
  "/home/lmackay/gdrive/Research/Anmar/P2X-data/P2X7/Models/linearODESolvecalP2X7.m"
};

static emlrtRSInfo nb_emlrtRSI = { 7, "linearODESolvecalP2X7",
  "/home/lmackay/gdrive/Research/Anmar/P2X-data/P2X7/Models/linearODESolvecalP2X7.m"
};

static emlrtRSInfo ob_emlrtRSI = { 52, "expm",
  "/usr/local/pkgs/MATLAB/R2013a/toolbox/eml/lib/matlab/matfun/expm.m" };

static emlrtRSInfo pb_emlrtRSI = { 62, "expm",
  "/usr/local/pkgs/MATLAB/R2013a/toolbox/eml/lib/matlab/matfun/expm.m" };

static emlrtRSInfo qb_emlrtRSI = { 64, "expm",
  "/usr/local/pkgs/MATLAB/R2013a/toolbox/eml/lib/matlab/matfun/expm.m" };

static emlrtRTEInfo m_emlrtRTEI = { 6, 2, "linearODESolvecalP2X7",
  "/home/lmackay/gdrive/Research/Anmar/P2X-data/P2X7/Models/linearODESolvecalP2X7.m"
};

static emlrtBCInfo m_emlrtBCI = { -1, -1, 8, 5, "Y", "linearODESolvecalP2X7",
  "/home/lmackay/gdrive/Research/Anmar/P2X-data/P2X7/Models/linearODESolvecalP2X7.m",
  0 };

static emlrtRTEInfo n_emlrtRTEI = { 63, 5, "expm",
  "/usr/local/pkgs/MATLAB/R2013a/toolbox/eml/lib/matlab/matfun/expm.m" };

static emlrtBCInfo n_emlrtBCI = { -1, -1, 7, 17, "Tsoln",
  "linearODESolvecalP2X7",
  "/home/lmackay/gdrive/Research/Anmar/P2X-data/P2X7/Models/linearODESolvecalP2X7.m",
  0 };

static emlrtDCInfo emlrtDCI = { 7, 17, "linearODESolvecalP2X7",
  "/home/lmackay/gdrive/Research/Anmar/P2X-data/P2X7/Models/linearODESolvecalP2X7.m",
  1 };

static emlrtBCInfo o_emlrtBCI = { -1, -1, 9, 3, "I", "linearODESolvecalP2X7",
  "/home/lmackay/gdrive/Research/Anmar/P2X-data/P2X7/Models/linearODESolvecalP2X7.m",
  0 };

/* Function Definitions */
void linearODESolvecalP2X7(void)
{
  real_T c_imin;
  int32_T i2;
  int32_T i;
  ...
  static const int8_T iv10[5] = { 3, 5, 7, 9, 13 };
  ...
  c_imin = imin;
  i2 = (int32_T)(imax + (1.0 - imin));
  emlrtForLoopVectorCheckR2012b(imin, 1.0, imax, mxDOUBLE_CLASS, i2,
    &m_emlrtRTEI, emlrtRootTLSGlobal);
  i = 0;
  while (i <= i2 - 1) {
    b_i = c_imin + (real_T)i;
    ...
    j = Tsoln->size[0];
    c_i = (int32_T)emlrtIntegerCheckFastR2012b(b_i, &emlrtDCI,
      emlrtRootTLSGlobal);
    normA = Tsoln->data[emlrtDynamicBoundsCheckFastR2012b(c_i, 1, j, &n_emlrtBCI,
      emlrtRootTLSGlobal) - 1] - t0;
    for (j = 0; j < 576; j++) {
      y[j] = Q[j] * normA;
    }
    ...
    while ((exitg2 == FALSE) && (j < 24)) {
      ...
      for (c_i = 0; c_i < 24; c_i++) {
        s += muDoubleScalarAbs(y[c_i + 24 * j]);
      }
    ...
    if (normA <= 5.3719203511481517) {
      ...
      while ((exitg1 == FALSE) && (c_i < 5)) {
        if (normA <= theta[c_i]) {
          ...
          PadeApproximantOfDegree(y, iv10[c_i], F);
      ...
      emlrtForLoopVectorCheckR2012b(1.0, 1.0, s, mxDOUBLE_CLASS, (int32_T)s,
        &n_emlrtRTEI, emlrtRootTLSGlobal);
    ...
    j = Y->size[0];
    c_i = (int32_T)b_i;
    emlrtDynamicBoundsCheckFastR2012b(c_i, 1, j, &m_emlrtBCI, emlrtRootTLSGlobal);
    for (j = 0; j < 24; j++) {
      Y->data[((int32_T)b_i + Y->size[0] * j) - 1] = p0[j];
    }

    Y_dirty |= 1U;
    j = I->size[0];
    c_i = (int32_T)b_i;
    I->data[emlrtDynamicBoundsCheckFastR2012b(c_i, 1, j, &o_emlrtBCI,
      emlrtRootTLSGlobal) - 1] = Acell * 1.0E+12 * (g12 * (((p0[4] + p0[5]) +
      p0[14]) + p0[15]) * (V - E12) + g34 * (((p0[6] + p0[7]) + p0[23]) + p0[22])
      * (V - E34));
    I_dirty |= 1U;
    i++;
...
/* End of code generation (linearODESolvecalP2X7.c) */
