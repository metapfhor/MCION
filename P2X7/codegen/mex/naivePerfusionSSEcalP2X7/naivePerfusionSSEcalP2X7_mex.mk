...
MAKEFILE = naivePerfusionSSEcalP2X7_mex.mk

include naivePerfusionSSEcalP2X7_mex.mki
...
SRC_FILES =  \
	...
	naivePerfusionSSEcalP2X7_emxutil.c \
	naivePerfusionSSEcalP2X7_mex.c

MEX_FILE_NAME_WO_EXT = naivePerfusionSSEcalP2X7_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/naivePerfusionSSEcalP2X7"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/naivePerfusionSSEcalP2X7/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/naivePerfusionSSEcalP2X7/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/naivePerfusionSSEcalP2X7/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
