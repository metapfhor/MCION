...
[err00,Ncell] = dataEnsembleError(exp1,anmarP2X7);
[err0,Ncell] = dataEnsembleError(exp3,anmarP2X7);
[err1,Ncell] = dataEnsembleError(exp10,anmarP2X7);
[err2,Ncell] = dataEnsembleError(exp32,anmarP2X7);
[err3,Ncell]= dataEnsembleError(exp100,anmarP2X7);

[err1a,Ncell] = dataEnsembleError(exp10.activation,anmarP2X7);
[err2a,Ncell] = dataEnsembleError(exp32.activation,anmarP2X7);
[err3a,Ncell]= dataEnsembleError(exp100.activation,anmarP2X7);
...
%     continueChain(x0);
% 	figure(13);plotPanelsResponse(anmarP2X7);
% % 	plotPanelsActivation(anmarP2X7);
%     continueChain(xp0);
%     figure(14);plotPanelsResponse(anmarP2X7);
%     drawnow
% 
% 	
% end
...
disp(['Initial Parameters:', tchainString(x0,xp0)])
 ...
 continueChain(xp0);
 cf(15);plotPanelsResponse(anmarP2X7);
 cf(16);plotPanelsActivation(anmarP2X7);
    
 continueChain(x0);
 
 cf(13);plotPanelsResponse(anmarP2X7);
 
 
 cf(14);plotPanelsActivation(anmarP2X7);
