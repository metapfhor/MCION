...
paramNames={'K1','k1','K2','k3','K3','k5','K4','L3','K5','k7','K6','k9','K7','k11','L1','L2','L3','H1','H2','H3','H4','H5','H6','H7','g12','g34','E12','E34','koff','C','V','A','alpha0'};
...
err1=normDataError(exp1,fullP2X7Therm,0.1);
err2 = normDataError(exp3,fullP2X7Therm,0.1);
err3=normDataError(exp10,fullP2X7Therm,10);
err4=normDataError(exp32,fullP2X7Therm,5);
err5=normDataError(exp100,fullP2X7Therm,5);
...
[X, m, R, theta, beta, stats, sse, XA] = cell_adaptive_pt(@(x,l) -(err1(x,l)+err2(x,l)+err4(x,l)+err5(x,l)), param, Niter, 3);
...
goodSamples=cullChain(X,sse,8000);
