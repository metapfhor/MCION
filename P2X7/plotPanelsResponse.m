...
plotNaiveResponse(exp1,model,2,5,1,6);


plotNaiveResponse(exp3,model,2,5,2,7);

plotNaiveResponse(exp10,model,2,5,3,8);

plotNaiveResponse(exp32,model,2,5,4,9);

plotNaiveResponse(exp100,model,2,5,5,10);
