...
err1=dataEnsembleError(exp1.activation,fullP2X7Therm);
err2 = dataEnsembleError(exp1.activation,fullP2X7Therm);
err3=dataEnsembleError(exp1.activation,fullP2X7Therm);
err4=dataEnsembleError(exp1.activation,fullP2X7Therm);
err5=dataEnsembleError(exp1.activation,fullP2X7Therm);
...
Acell=1;
 ...
 cf(13);plotPanelsResponse(fullP2X7Therm);
  cf(14);plotPanelsActivation(fullP2X7Therm);
