...
paramNames={'k1','k2','k3','k4','k5','k6','L1','L2','L3','H1','H2','H3','H4','H5','H6','H7','g12','g34','E12','E34','r1','r2','kca','koff','C','V','A','n','EC'};
...
%No Cal, High ATP
[err1,Ncell] = cellDataError(exp1,compP2X7);
[err2,Ncell]=cellDataError(exp10,compP2X7);
[err3,Ncell]=cellDataError(exp100,compP2X7);
...
[X, m, R, theta, beta, stats, sse, XA] = cell_adaptive_pt(@(x,l) -(10000*err1(x,l)+(err3(x,l)+err2(x,l))/10), param, Niter, 1);
...
goodSamples=cullChain(X,sse, 1.7*10^6);
...
cf(3);plotChainPanels(compP2X7,goodSamples,10);
