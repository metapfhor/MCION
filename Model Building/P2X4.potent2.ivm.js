...
stateNames=['C1','C2','C3','C4','C5','C6','C7','C8','Q1','Q2','Q3','Q4','Q5','Q6','Q7','Q8','D1','D2','D3','D4','Z_','IM'];
paramNames=['kon','koff','k1','k2','k3','k4','k5','k6','L1','L2','L3','L4','L5','L6','L7','H1','H2','H3','H4','g1','g2','E1','E2','delta','epsilon','mu','A','J','V','n1','n2','n3','v1','v2','v3','r1','r2','r3','a1','a2','alpha','beta','gamma'];
...
IVM1=times('L2',hill(IM,'delta','n1'));
IVM2=times('L4',hill(IM,'epsilon','n2'));
IVM3=times('L6',hill(IM,'mu','n3'));

IM.addProductionTerm('kon*J',1);
IM.addProductionTerm('koff',0);
...
m.linkStates(C4,C6,times('alpha',IVM2),'L3');
m.linkStates(Q3,Q5,times('beta',IVM2),'L3');
m.linkStates(Q4,Q6,times('gamma',IVM2),'L3');
...
//Internalization 
m.linkStates(D4,Z_,'H3');
//Externalization
m.linkStates(D1,C1,'H1');
m.linkStates(Z_,C1,'H4');


opened=plus(Q1,Q2,Q3,Q4,Q5,Q6);
fopened=minus('V','E1');
Iopened=times('g1',plus(Q1,Q2,times('a1',plus(Q3,Q4)),times('a2',plus(Q5,Q6))),fopened)
...
m.watched=[Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q8,IM];
