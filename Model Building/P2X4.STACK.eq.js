...
m.linkStates(Q1,D12,'kd1','ks1');
m.linkStates(Q2,D12,'kd1','ks1');

m.linkStates(C4,D22,'kd2','ks2');
m.linkStates(Q3,D22,'kd2','ks2');
m.linkStates(Q4,D22,'kd2','ks2');

m.linkStates(C6,D32,'kd3','ks3');
m.linkStates(Q5,D32,'kd3','ks3');
m.linkStates(Q6,D32,'kd3','ks3');

m.linkStates(C8,D42,'kd4','ks4');
m.linkStates(Q7,D42,'kd4','ks4');
m.linkStates(Q8,D42,'kd4','ks4');
