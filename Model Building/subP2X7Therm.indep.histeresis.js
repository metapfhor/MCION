...
paramNames=['K1','k1','K2','k3','K3','k5','K5','k7','K6','k9','K7','k11','L1','K4','L3','g12','g34','E12','E34','A','V','alpha'];
m=new model('fullP2X7ThermHist');
...
//middle row
m.linkStates(C1,C2,'alpha*k2*A','alpha*k1');
m.linkStates(C2,O1,'alpha*k4*A','alpha*k3');
m.linkStates(O1,O2,'alpha*k6*A','alpha*k5');
