...
paramNames=['k1','k2','k3','k4','k5','k6','k7','k8','k9','k10','k11','k12','k13','k14','k15','k16','k17','k18','k19','k20','k21','k22','k23','k24','L11','L12','L13','L14','L21','L22','L23','L24','L31','L32','L33','L34','L41','L42','L43','L44','L51','L52','L53','L54','L61','L62','L63','L64','W2','H0','H5','kd1','kd2','kd3','kd4','ks1','ks2','ks3','ks4','H3','H3D','H4','g1','g2','E1','E2','delta','epsilon','mu','A','V'];


m=new model('P2XInact2noallo');
...
hill1=hill(1,'delta',4);
hill2=hill(1,'epsilon',4);
hill3=hill(1,'mu',4);

IVM10=times('W2',hill(1,'delta',4));
IVM11=times('L21',hill(1,'delta',4));
IVM12=times('L22',hill(1,'delta',4));
IVM13=times('L23',hill(1,'delta',4));
IVM14=times('L24',hill(1,'delta',4));


IVM21=times('L41',hill(1,'epsilon',4));
IVM22=times('L42',hill(1,'epsilon',4));
IVM23=times('L43',hill(1,'epsilon',4));
IVM24=times('L44',hill(1,'epsilon',4));


IVM31=times('L61',hill(1,'mu',4));
IVM32=times('L62',hill(1,'mu',4));
IVM33=times('L63',hill(1,'mu',4));
IVM34=times('L64',hill(1,'mu',4));


IVM11D=times('L21',hill(1,'delta',4));
IVM12D=times('L22',hill(1,'delta',4));
IVM13D=times('L23',hill(1,'delta',4));
IVM14D=times('L24',hill(1,'delta',4));

IVM21D=times('L41',hill(1,'epsilon',4));
IVM22D=times('L42',hill(1,'epsilon',4));
IVM23D=times('L43',hill(1,'epsilon',4));
IVM24D=times('L44',hill(1,'epsilon',4));

IVM31D=times('L61',hill(1,'mu',4));
IVM32D=times('L62',hill(1,'mu',4));
IVM33D=times('L63',hill(1,'mu',4));
IVM34D=times('L64',hill(1,'mu',4));
...
//1st Binding of IVM
m.linkStates(C0,C3,0);
m.linkStates(C1,C3,0,'L11');
