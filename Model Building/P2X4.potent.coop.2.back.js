...
paramNames=['k1','k2','k3','k4','k5','k6','L1','L2','L3','L4','L5','L6','H1','H2','H2','H2','H3','H4','g1','g2','E1','E2','delta','epsilon','mu','A','J','V','n1','n2','n3','v1','v2','v3','r1','r2','r3','rho1','rho2','rho3','gamma1','gamma2','gamma3'];


m=new model('potentP2X4coop2back');
...
m.linkStates(C2,C4,times('rho1',IVM1),times('gamma1','L1'));
m.linkStates(Q1,Q3,times('rho2',IVM1),times('gamma2','L1'));
m.linkStates(Q2,Q4,times('rho3',IVM1),times('gamma3','L1'));
...
m.linkStates(C4,C6,times('rho1',IVM2),times('gamma1','L3'));
m.linkStates(Q3,Q5,times('rho2',IVM2),times('gamma2','L3'));
m.linkStates(Q4,Q6,times('rho3',IVM2),times('gamma3','L3'));
...
m.watched=[C3,C5,C7,Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q8]
