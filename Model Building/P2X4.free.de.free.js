...
paramNames=['k1','k2','k3','k4','k5','k6','k7','k8','k9','k10','k11','k12','k13','k14','k15','k16','k17','k18','k19','k20','k21','k22','k23','k24','L11','L12','L13','L14','L21','L22','L23','L24','L31','L32','L33','L34','L41','L42','L43','L44','L51','L52','L53','L54','L61','L62','L63','L64','H1','H11','H12','H13','kd','ks','kd1','ks1','kd2','ks2','kd3','ks3','kd4','ks4','H3','g1','g2','E1','E2','delta','epsilon','mu','A','J','V'];


m=new model('P2X4freeDefree');
...
m.linkStates(C4,D2,'kd',times('ks',hill1));
m.linkStates(Q3,D3,'kd1',times('ks1',hill1));
m.linkStates(Q4,D4,'kd2',times('ks2',hill1));

m.linkStates(C6,D2,'kd1',times('ks1',hill2));
m.linkStates(Q5,D3,'kd2',times('ks2',hill2));
m.linkStates(Q6,D4,'kd3',times('ks3',hill2));

m.linkStates(C8,D2,'kd2',times('ks2',hill3));
m.linkStates(Q7,D3,'kd3',times('ks3',hill3));
m.linkStates(Q8,D4,'kd4',times('ks4',hill3));
