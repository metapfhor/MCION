...
stateNames=['C0','C1','C2','Q1','Q2','D11','D12','D13','D14','Z'];
paramNames=['d1','d2','d3','d4','d5','d6','k1','k2','k3','k4','k5','k6','H0','H1','H2','H3','H4','H5','g1','g2','E1','E2','delta','epsilon','mu','A','J','V'];


m=new model('P2X4Inactsub');
