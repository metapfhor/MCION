...
paramNames=['k1','k2','k3','k4','k5','k6','L1','L2','L3','L4','L5','L6','H1','H2','H3','H4','g1','g2','E1','E2','delta','epsilon','mu','A','J','V','n1','n2','n3','v1','v2','v3','r1','r2','r3','rho1','rho2','rho3'];


m=new model('potentP2X4coop3');
...
m.linkStates(C6,C8,times('rho1',IVM3),'L5');
m.linkStates(Q5,Q7,times('rho2',IVM3),'L5');
m.linkStates(Q6,Q8,times('rho3',IVM3),'L5');
