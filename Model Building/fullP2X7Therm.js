...
paramNames=['K1','k1','K2','k3','K3','k5','K5','k7','L1','K4','L3','H1','H2','H3','H4','H5','H6','H7','g12','g34','E12','E34','alpha1','alpha3','alpha32','alpha100'];
...
m.addAuxiliary({alpha:'unitDefaultMap(A==[1e-7,3e-7,3e-6,1e-5],[alpha1,alpha3,alpha32,alpha100])',k2:'alpha*K1*k1/3',k4:'alpha*K2*k3',k6:'alpha*K3*k5*3',L2:'L3/K4',k8:'alpha*K5*k7/3'});
