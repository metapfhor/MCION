...
paramNames=['k1','k2','k3','k4','k5','k6','k7','k8','k9','k10','k11','k12','k13','k14','k15','k16','k17','k18','k19','k20','k21','k22','k23','k24','L11','L12','L13','L14','L21','L22','L23','L24','L31','L32','L33','L34','L41','L42','L43','L44','L51','L52','L53','L54','L61','L62','L63','L64','W2','H0','H5','kd1','kd2','kd3','kd4','ks1','ks2','ks3','ks4','H3','H3D','H4','g1','g2','E1','E2','delta','epsilon','mu','A','J','V'];


m=new model('P2X4Inact2');
...
IVM11D=times('L21',hill('J','delta',4));
IVM12D=times('L22',hill('J','delta',4));
IVM13D=times('L23',hill('J','delta',4));
IVM14D=times('L24',hill('J','delta',4));

IVM21D=times('L41',hill('J','epsilon',4));
IVM22D=times('L42',hill('J','epsilon',4));
IVM23D=times('L43',hill('J','epsilon',4));
IVM24D=times('L44',hill('J','epsilon',4));

IVM31D=times('L61',hill('J','mu',4));
IVM32D=times('L62',hill('J','mu',4));
IVM33D=times('L63',hill('J','mu',4));
IVM34D=times('L64',hill('J','mu',4));
