...
paramNames=['k1','k2','k3','k4','k5','k6','L1','L2','L3','L4','L5','L6','H1','H2','H2','H2','H3','H4','g1','g2','E1','E2','delta','epsilon','mu','A','J','V','n1','n2','n3','v1','v2','v3','r1','r2','r3','rho1','rho2','rho3'];
...
m.linkStates(Q1,Q3,times('rho1^2',IVM1),'L1');
m.linkStates(Q2,Q4,times('rho1^3',IVM1),'L1');
...
m.linkStates(C4,C6,times('rho2',IVM2),'L3');
m.linkStates(Q3,Q5,times('rho2^2',IVM2),'L3');
m.linkStates(Q4,Q6,times('rho2^3',IVM2),'L3');
