...
paramNames=['k1','k2','k3','k4','k5','k6','kd1','ku1','kd2','ku2','kd3','ku3','L1','L2','L3','L4','L5','L6','L7','L8','L9','L10','H1','H2','H3','H4','g1','g2','E1','E2','delta','epsilon','mu','A','J','V','n1','n2','n3','v1','v2','v3','r1','r2','r3','w1','w2','w3','s1','s2','s3','rho1','rho2','rho3'];


m=new model('potentP2X4poolindep');
...
IVM2D=times('L8',hill('J','epsilon',4));
IVM3D=times('L10',hill('J','mu',4));
...
m.linkStates(CD3,CD5,IVM2D,'L7');
m.linkStates(CD4,CD6,times('rho1',IVM2D),'L7');
m.linkStates(QD3,QD5,times('rho2',IVM2D),'L7');
m.linkStates(QD4,QD6,times('rho3',IVM2D),'L7');
...
m.linkStates(CD5,CD7,IVM3D,'L9');
m.linkStates(CD6,CD8,IVM3D,'L9');
m.linkStates(QD5,QD7,IVM3D,'L9');
m.linkStates(QD6,QD8,IVM3D,'L9');
