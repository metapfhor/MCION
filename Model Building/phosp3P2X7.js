...
opened2=plus(O5,O6);
opened3=plus(O7,O8);
openedCond=plus(times('g0',opened0),times('g1',opened1),times('g2',opened2),times('g3',opened3));
fopened=minus('V','E12');
...
//3-phosporylation row
m.linkStates(C7,C8,open0,close1);
m.linkStates(C8,O7,open1,close2);
m.linkStates(O7,O8,open2,close3);
...
m.linkStates(O2,O4,'L3','L2');//phosphorylation pathway (1)
m.linkStates(O4,O6,'L3','L2');//phosphorylation pathway (2)
m.linkStates(O6,O8,'L3','L2');//phosphorylation pathway (3)
m.linkStates(O8,S4,'L5','L6');//sensitization pathway
