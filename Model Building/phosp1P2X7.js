...
opened0=plus(O1,O2);
opened1=plus(O3,O4);
openedCond=plus(times('g0',opened0),times('gd',opened1));
fopened=minus('V','E12');
...
m.linkStates(O2,O4,'L3','L2');//phosphorylation pathway
m.linkStates(O4,S4,'L5','L6');//sensitization pathway
