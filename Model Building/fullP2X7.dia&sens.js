...
stateNames=['C1','C2','C3','C4','O1','O2','O3','O4','S1','S2','S3','S4']
paramNames=['k1','k2','k3','k4','k5','k6','k7','k8','k9','k10','k11','k12','L1','L2','L3','L4','L5','L6','H1','H2','H3','H4','H5','H6','H7','g12','g34','E12','E34','A','V'];
...
sens=plus(S3,S4);
//sens=new power(sens,3);
dilated = plus(O3,O4,sens);
...
//dilated row
m.linkStates(C4,C3,open0,close1);
m.linkStates(C3,O4,open1,close2);
m.linkStates(O4,O3,open2,close3);
...
m.linkStates(S1,C1,'L4');//back to naive state
m.linkStates(O2,O3,'L3','L2');//dilation pathway
m.linkStates(O4,O1,'L2');//dilation pathway
m.linkStates(O3,S4,'L5','L6');//sensitization pathway
m.linkStates(O4,S3,'L5','L6');//sensitization pathway
