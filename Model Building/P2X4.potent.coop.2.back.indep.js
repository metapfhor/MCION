...
paramNames=['k1','k2','k3','k4','k5','k6','k7','k8','k9','k10','k11','k12','L11','L12','L13','L14','L21','L22','L23','L24','L31','L32','L33','L34','L41','L42','L43','L44','L5','L6','H1','H2','H2','H2','H3','H4','g1','g2','E1','E2','delta','epsilon','mu','A','J','V','n1','n2','n3','v1','v3','r1','r3'];


m=new model('potentP2X4two');
...
open32=times('k10','A');
open33=times('k12','A');
open41=times('r3*k8','A');
open42=times('r3*k10','A');
open43=times('r3*k12','A');
...
//2nd IVM Row
m.linkStates(C5,C6,open31,'k7');
m.linkStates(C6,Q5,open32,'k9');
m.linkStates(Q5,Q6,open33,'k11');



//3rd IVM Row
m.linkStates(C7,C8,open41,'v3*k7');
m.linkStates(C8,Q7,open42,'v3*k9');
m.linkStates(Q7,Q8,open43,'v3*k11');
