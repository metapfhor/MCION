...
paramNames=['k1','k2','k3','k4','k5','k6','k7','k8','k9','k10','k11','k12','kd0','ku0','kd1','ku1','kd2','ku2','kd3','ku3','L1','L2','L3','L4','L5','L6','H1','H2','H3','H4','g1','g2','E1','E2','delta','epsilon','mu','A','J','V','n1','n2','n3','v1','v2','v3','r1','r2','r3','alpha','a1','a2','a3'];


m=new model('potentP2X4');
...
m.linkStates(CD2,CD4,IVM1,'L1');
m.linkStates(QD1,QD3,IVM1,'L1');
m.linkStates(QD2,QD4,IVM1,'L1');
...
m.linkStates(CD4,CD6,IVM2,'L3');
m.linkStates(QD3,QD5,IVM2,'L3');
m.linkStates(QD4,QD6,IVM2,'L3');
...
dilated=plus(QD3,QD4,QD5,QD6,QD7,QD8);
fdilated=minus('V','E2');
