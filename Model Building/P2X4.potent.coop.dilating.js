...
m=new model('potentP2X4coop3dil');
...
m.linkStates(Q2,Q4,('rho3',IVM1),'L1');
...
m.linkStates(CD6,CD8,times('rho1',IVM3),'L5');
m.linkStates(QD5,QD7,times('rho2',IVM3),'L5');
m.linkStates(QD6,QD8,times('rho3',IVM3),'L5');
