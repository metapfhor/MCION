function ode = modelPulseODEpotent2P2X4revcoop(ton,toff)
global k1 k2 k3 k4 k5 k6 L1 L2 L3 L4 L5 L6 L7 H1 H2 H3 H4 g1 g2 E1 E2 delta epsilon mu A J V n1 n2 n3 v1 v2 v3 r1 r2 r3 a1 a2 alpha beta gamma A0 J0 IVMon IVMoff;
	ATP=@(t) 0;
	for i=1:length(ton)
	...
	function dy=model(t,y)
		setAuxiliarypotent2P2X4revcoop(y);
		dy=zeros(21,1);
		A=ATP(t);
		J=IVM(t);
		...
		dy(6)=r2*k2*A*y(5)+v2*k3*y(13)+alpha*L4*J^n2/(J^n2+epsilon^n2)*y(4)+L7*y(8)-(v2*k1+r2*k4*A+L3)*y(6);%C6
		...
		dy(13)=r2*k4*A*y(6)+v2*k5*y(14)+beta*L4*J^n2/(J^n2+epsilon^n2)*y(11)+L7*y(15)-(v2*k3+r2*k6*A+L3)*y(13);%Q5
