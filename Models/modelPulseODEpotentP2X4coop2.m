function ode = modelPulseODEpotentP2X4coop2(ton,toff)
global k1 k2 k3 k4 k5 k6 L1 L2 L3 L4 L5 L6 H1 H2 H2 H2 H3 H4 g1 g2 E1 E2 delta epsilon mu A J V n1 n2 n3 v1 v2 v3 r1 r2 r3 rho1 rho2 rho3 A0 J0 IVMon IVMoff;
	...
	function dy=model(t,y)
		...
		dy(6)=r2*k2*A*y(5)+v2*k3*y(13)+rho1*L4*J^4/(J^4+epsilon^4)*y(4)+L5*y(8)-(v2*k1+r2*k4*A+L3+L6*J^4/(J^4+mu^4))*y(6);%C6
		...
		dy(13)=r2*k4*A*y(6)+v2*k5*y(14)+rho2*L4*J^4/(J^4+epsilon^4)*y(11)+L5*y(15)-(v2*k3+r2*k6*A+L3+L6*J^4/(J^4+mu^4))*y(13);%Q5
		dy(14)=r2*k6*A*y(13)+rho3*L4*J^4/(J^4+epsilon^4)*y(12)+L5*y(16)-(v2*k5+L3+L6*J^4/(J^4+mu^4))*y(14);%Q6
