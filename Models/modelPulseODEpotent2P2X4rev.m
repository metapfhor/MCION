function ode = modelPulseODEpotent2P2X4rev(ton,toff)
global k1 k2 k3 k4 k5 k6 L1 L2 L3 L4 L5 L6 L7 H1 H2 H3 H4 g1 g2 E1 E2 delta epsilon mu A J V n1 n2 n3 v1 v2 v3 r1 r2 r3 a1 a2 A0 J0 IVMon IVMoff;
	ATP=@(t) 0;
	for i=1:length(ton)
