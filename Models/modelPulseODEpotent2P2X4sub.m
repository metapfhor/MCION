function ode = modelPulseODEpotent2P2X4sub(ton,toff)
global k1 k2 k3 k4 k5 k6 H1 H2 H3 H4 g1 g2 E1 E2 A J V A0 J0 IVMon IVMoff;
	ATP=@(t) 0;
	for i=1:length(ton)
