function h = plotNaiveResponsepotentP2X4coop3dil(experiment)
	setParams([]);
	...
	plot(T,[Y(:,17)+Y(:,18)+(Y(:,19)+Y(:,20))*a1+(Y(:,21)+Y(:,22))*a2+(Y(:,23)+Y(:,24))*a3, Y(:,25)+Y(:,26)+Y(:,27)+Y(:,28)+Y(:,29)+Y(:,30)+Y(:,31)+Y(:,32)]);
	legend('Open','Dilated');
