function ode = modelPulseODEpotent2P2X4(ton,toff)
global k1 k2 k3 k4 k5 k6 L1 L2 L3 L4 L5 L6 H1 H2 H3 H4 g1 g2 E1 E2 delta epsilon mu A J V n1 n2 n3 v1 v2 v3 r1 r2 r3 a1 a2 A0 J0 IVMon IVMoff;
	ATP=@(t) 0;
	for i=1:length(ton)
	...
	function dy=model(t,y)
		...
		dy(5)=v2*k1*y(6)+L4*J^n2/(J^n2+epsilon^n2)*y(3)+L5*y(7)-(r2*k2*A+L3)*y(5);%C5
		dy(6)=r2*k2*A*y(5)+v2*k3*y(13)+L4*J^n2/(J^n2+epsilon^n2)*y(4)+L5*y(8)-(v2*k1+r2*k4*A+L3)*y(6);%C6
		dy(7)=v3*k1*y(8)-(r3*k2*A+L5)*y(7);%C7
		dy(8)=r3*k2*A*y(7)+v3*k3*y(15)-(v3*k1+r3*k4*A+L5)*y(8);%C8
		...
		dy(13)=r2*k4*A*y(6)+v2*k5*y(14)+L4*J^n2/(J^n2+epsilon^n2)*y(11)+L5*y(15)-(v2*k3+r2*k6*A+L3)*y(13);%Q5
		dy(14)=r2*k6*A*y(13)+L4*J^n2/(J^n2+epsilon^n2)*y(12)+L5*y(16)-(v2*k5+L3+L6*J^n3/(J^n3+mu^n3))*y(14);%Q6
		dy(15)=r3*k4*A*y(8)+v3*k5*y(16)-(v3*k3+r3*k6*A+L5)*y(15);%Q7
