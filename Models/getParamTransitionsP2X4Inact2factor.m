function tr=getParamTransitionsP2X4Inact2factor(p)
	switch p
	case 'k1'
		tr='{C2,C4,C6,C8,D12,D22,D32,D42}->{C1,C3,C5,C7,D11,D21,D31,D41}';
	case 'k2'
		tr='{C1,C3,C5,C7,D11,D21,D31,D41}->{C2,C4,C6,C8,D12,D22,D32,D42}';
	case 'k3'
		tr='{Q1,Q3,Q5,Q7,D13,D23,D33,D43}->{C2,C4,C6,C8,D12,D22,D32,D42}';
	case 'k4'
		tr='{C2,C4,C6,C8,D12,D22,D32,D42}->{Q1,Q3,Q5,Q7,D13,D23,D33,D43}';
	case 'k5'
		tr='{Q2,Q4,Q6,Q8,D14,D24,D34,D44}->{Q1,Q3,Q5,Q7,D13,D23,D33,D43}';
	case 'k6'
