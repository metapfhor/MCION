function err = errorIntegratorThreeP2X7Forward(ton,toff,Ttot,amp,dt,y0,T,I,V)
global k2 k4 g12 E12;
	...
	for j=1:nT-1
		...
		yup(3)=(ycurr(3)+dt*(2*k4*A+ycurr(2)))/(1+dt*());%O1
		...
		if deltaT<deltaTNext && deltaT<deltaTPrev
			err=err+abs(10^12*g12*ycurr(3)*(V-E12)-I(i))^2;
			i=i+1;
			Tcurr=T(i);
		end
	end
