...
global k1 k2 k3 k4 k5 k6 k7 k8 k9 k10 k11 k12 L1 K4 L3 H1 H2 H3 H4 H5 H6 H7 g12 g34 E12 E34 A V n rd K1 K2 K3 g34 L2;
	...
	function dy=model(t,y)
		...
		dy(3)=3*k12*A*y(4)+2*k9*y(8)-(k11+2*k10*A)*y(3);%C3
		dy(4)=k11*y(3)-(3*k12*A+L1)*y(4);%C4
		dy(5)=2*k4*A*y(2)+3*k5*y(6)+H5*y(11)-(2*k3+k6*A+H4)*y(5);%O1
		dy(6)=k6*A*y(5)+L2*y(7)+H3*y(12)-(3*k5+L3+H2)*y(6);%O2
		dy(7)=k8*A*y(8)+L3*y(6)-(3*k7+L2)*y(7);%O3
		dy(8)=2*k10*A*y(3)+3*k7*y(7)-(2*k9+k8*A)*y(8);%O4
